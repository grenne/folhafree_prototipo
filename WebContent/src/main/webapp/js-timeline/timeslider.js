...
(function ($) {
    ...
    TimeSlider.prototype.add_graduations = function() {
        ...
        for (var i = -4; i <= num_steps; i++) {
            ...
            this.$ruler.append(
                '<div id="graduation-title-hour' + i + '" class="graduation-title day-size' + (caret_class ? '' : ' hidden') + '" style="left:' + (left - 40).toString() + 'px">' +
    ...
    TimeSlider.prototype.add_cell = function(timecell) {
        ...
        if (! this.$ruler.find('#' + timecell['_id']).length) {
            ...
            // aqui monta o evento entre os div colocar o dia
            this.$ruler.append(
